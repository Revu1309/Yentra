...
export default function WhyChooseSection() {
  const reasons = [
    {
      ...
      icon: (
        <svg className="w-7 h-7 text-purple-400" width="28" height="28" style={{width:28,height:28,flexShrink:0}} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="why-choose-us" className="relative py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <SectionHeading
