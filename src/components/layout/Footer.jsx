...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-background/90 border-t border-white/10 pt-20 pb-12 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-purple-600/10 blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-full bg-white/5 hover:bg-purple-500/20 border border-white/10 hover:border-purple-500/40 flex items-center justify-center text-foreground/80 hover:text-purple-400 transition-all duration-300"
              >
        ...
        {/* Divider & Bottom Row */}
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-foreground/60">
