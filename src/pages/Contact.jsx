    ...
    <div className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 mb-28">
        ...
        <div className="lg:col-span-7">
          <GlassCard className="p-8 sm:p-12" glowColor="purple" hoverEffect={false}>
            ...
            {status === 'success' ? (
              <div className="p-8 rounded-2xl bg-purple-500/10 border border-purple-500/40 text-center space-y-4 animate-fade-up">
                <div className="w-16 h-16 rounded-full bg-purple-500/20 text-purple-400 mx-auto flex items-center justify-center text-3xl">
                  ✓
                </div>
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-full bg-white/10 hover:bg-white/20 text-sm font-medium text-foreground transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 text-foreground text-sm transition-all"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 text-foreground text-sm transition-all [&>option]:bg-background [&>option]:text-foreground"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 text-foreground text-sm transition-all resize-none"
                  />
                </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <GlassCard className="p-8" glowColor="purple">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-sm transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)]"
            >
          ...
          <GlassCard className="p-8 space-y-6" glowColor="purple">
            <div>
              ...
              <a
                ...
                className="text-lg font-display font-semibold text-foreground hover:text-purple-400 transition-colors"
              >
                +1 (555) 019-2834
              </a>
              <p className="text-xs text-foreground/60 mt-0.5">Mon — Fri, 9:00 AM — 6:00 PM EST</p>
            </div>
            ...
            <div className="border-t border-white/5 pt-4">
              ...
              <p className="text-xs text-foreground/60 mt-0.5">For proposals, RFPs & general inquiries</p>
            </div>
            ...
            <div className="border-t border-white/5 pt-4">
              ...
              <p className="text-sm text-foreground/70">San Francisco, CA 94105, USA</p>
            </div>

            {/* Social Icons Strip */}
            <div className="border-t border-white/5 pt-6">
              <span className="text-xs font-semibold uppercase tracking-wider text-foreground/60 block mb-3">
                Connect With Us
              </span>
              <div className="flex items-center gap-3">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-full bg-white/5 hover:bg-purple-500/20 border border-white/10 hover:border-purple-500/40 flex items-center justify-center text-foreground/80 hover:text-purple-400 transition-all"
                >
